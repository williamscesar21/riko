        ...
        <section className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 pt-4">
            <a 
              ...
              href="https://wa.me/584227198014?text=Para%20registrarse%20en%20Riko%20App%2C%20deben%20indicar%20el%20nombre%20del%20restaurante%2C%20correo%2C%20direcci%C3%B3n%2C%20tel%C3%A9fono%2C%20y%20todo%20el%20men%C3%BA%20con%20las%20im%C3%A1genes%20de%20los%20productos."
              target="_blank"
